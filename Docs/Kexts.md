...
| [IntelMausi.kext](https://github.com/devicemanager/IntelMausi) | 13.0.0 (10.9) | — | — |
| [IntelSnowMausi.kext](https://github.com/devicemanager/IntelMausi) | 10.0.0 (10.6) | 12.0.0 (10.8) | Not tested |
...
| [AirportBrcmFixup.kext](https://github.com/devicemanager/AirportBrcmFixup) | 12.0.0 (10.8) | 23.9.9 (14) | — |
| [ATH9KFixup.kext](https://github.com/chunnann/ATH9KFixup) | — | — | — |
| [BrcmPatchRAM](https://github.com/devicemanager/BrcmPatchRAM) | 14.0.0 (10.10) | 23.9.9 (14) | — |
...
|------------------------------|-----------------------|-----------------------|------|
| [BrightnessKeys.kext](https://github.com/devicemanager/BrightnessKeys) | — | — | — |
...
| [VoodooPS2Controller.kext](https://github.com/devicemanager/VoodooPS2) | 15.0.0 (10.11) | — | — |
| [VoodooPS2Keyboard.kext](https://github.com/devicemanager/VoodooPS2) | 15.0.0 (10.11) | — | — |
| [VoodooPS2Mouse.kext](https://github.com/devicemanager/VoodooPS2) | 15.0.0 (10.11) | — | — |
| [VoodooPS2Trackpad.kext](https://github.com/devicemanager/VoodooPS2) | 15.0.0 (10.11) | — | — |
| [VoodooInput.kext](https://github.com/devicemanager/VoodooInput) | 15.0.0 (10.11) | — | — |
...
|-----------------|-----------------------|-----------------------|------|
| [AppleALC.kext](https://github.com/devicemanager/AppleALC) | 8.0.0 (10.4) | 23.9.9 (14) | — |
| [AppleALCU.kext](https://github.com/devicemanager/AppleALC) | 8.0.0 (10.4) | 23.9.9 (14) | — |
...
| [WhateverGreen.kext](https://github.com/devicemanager/WhateverGreen) | 10.0.0 (10.6) | 23.9.9 (14) | — |
...
| [AppleMCEReporterDisabler.kext](https://github.com/devicemanager/bugtracker/issues/424#issuecomment-535624313) | — | — | — |
| [AsusSMC.kext](https://github.com/hieplpvip/AsusSMC) | — | — | — |
| [CPUFriend.kext](https://github.com/devicemanager/CPUFriend) | 10.0.0 (10.6) | 23.9.9 (14) | — |
...
| [CpuTscSync.kext](https://github.com/devicemanager/CpuTscSync) | 12.0.0 (10.8) | 23.9.9 (14) | — |
| [VirtualSMC.kext](https://github.com/devicemanager/VirtualSMC) | 8.0.0 (10.4) | 23.9.9 (14) | — |
| [SMCLightSensor.kext](https://github.com/devicemanager/VirtualSMC) | 10.0.0 (10.6) | — | Not tested 10.6 and 10.7 |
| [SMCSuperIO.kext](https://github.com/devicemanager/VirtualSMC) | 10.0.0 (10.6) | — | Not tested 10.6 and 10.7 |
| [SMCBatteryManager.kext](https://github.com/devicemanager/VirtualSMC) | 8.0.0 (10.4) | — | — |
| [SMCProcessor.kext](https://github.com/devicemanager/VirtualSMC) | 11.0.0 (10.7) | — | Not tested 10.7 |
| [SMCDellSensor.kext](https://github.com/devicemanager/VirtualSMC) | 11.0.0 (10.7) | — | Not tested 10.7 |
...
| [NVMeFix.kext](https://github.com/devicemanager/NVMeFix) | 18.0.0 (10.14) | 23.9.9 (14) | — |
...
| [EmeraldSDHC.kext](https://github.com/devicemanager/EmeraldSDHC) | — | — | — |

| Other kexts | MinKernel (Min macOS) | MaxKernel (Max macOS) | Note |
|-------------|-----------------------|-----------------------|------|
| [AppleIntelInfo.kext](https://github.com/headkaze/AppleIntelInfo) | — | — | — |
| [DebugEnhancer.kext](https://github.com/devicemanager/DebugEnhancer) | 12.0.0 (10.8) | 23.9.9 (14) | — |
| [HibernationFixup.kext](https://github.com/devicemanager/HibernationFixup) | 12.0.0 (10.8) | 23.9.9 (14) | — |
| [Lilu.kext](https://github.com/devicemanager/Lilu) | 8.0.0 (10.4) | 23.9.9 (14) | — |
| [RestrictEvents.kext](https://github.com/devicemanager/RestrictEvents) | 12.0.0 (10.8) | 23.9.9 (14) | — |
...
| [FeatureUnlock.kext](https://github.com/devicemanager/FeatureUnlock) | 16.0.0 (10.12) | 23.9.9 (14) | — |
| [MacHyperVSupport.kext](https://github.com/devicemanager/MacHyperVSupport) | 8.0.0 (10.4) | 23.9.9 (14) | — |
| [CryptexFixup.kext](https://github.com/devicemanager/CryptexFixup) | 20.0.0 (11) | 23.9.9 (14) | — |

More complete list with legacy kexts is hosted [here](https://docs.google.com/spreadsheets/d/15S-ocrkm_VTUJpKxNII-YUyQFd5VYdjbe0DHlZVCQyM). Full Lilu plugin list with legacy kexts is hosted [here](https://github.com/devicemanager/Lilu/blob/master/KnownPlugins.md). For developers only.   
devicemanager members are not affiliated with the authors of any kernel extensions but ones hosted at https://github.com/devicemanager. This list is provided for information purposes without warranty of any kind.  
